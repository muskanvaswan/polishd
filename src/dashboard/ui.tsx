...
export const card = `border ${border} rounded-lg bg-[#0a0a0a]`;
export const divider = `border-t ${border}`;
export const labelCls = "text-[11px] font-medium uppercase tracking-[0.08em] text-[#666]";
